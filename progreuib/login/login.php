...
<body class="bg-light">
    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 90vh;">
        <div class="card shadow-lg border-0 p-5 rounded-4" style="max-width: 480px; width: 100%;">
            ...
            <h3 class="text-center fw-bold mb-4"><i class='bx bx-log-in-circle'></i> Iniciar Sesión</h3>
            <form action="validacion/validacion.php" method="post">
                <div class="mb-3">
                    <label for="email" class="form-label fw-semibold"><i class='bx bx-envelope'></i> Correo electrónico</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class='bx bx-envelope'></i></span>
                        <input type="email" class="form-control" id="email" name="correo" placeholder="ejemplo@correo.com" value="<?php echo htmlspecialchars($_POST['correo'] ?? ''); ?>" required />
                    </div>
                </div>
                <div class="mb-3">
                    <label for="password" class="form-label fw-semibold"><i class='bx bx-lock'></i> Contraseña</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class='bx bx-lock'></i></span>
                        <input type="password" class="form-control" id="password" name="contraseña" placeholder="••••••••" value="<?php echo htmlspecialchars($_POST['contrasena'] ?? ''); ?>" required />
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-warning fs-4 fw-semibold text-dark">
            ...
            <div class="text-center mt-4">
                <p><i class='bx bx-user-plus'></i> ¿No tienes cuenta?
                    <a href="http://progreuib.edu.co/register/register.php" class="text-warning fw-semibold text-decoration-none">Regístrate aquí</a>
                </p>
            </div>
        </div>
    </div>
