...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-gradient shadow-sm fixed-top" style="background: linear-gradient(90deg, #003566, #0077b6);">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="http://progreuib.edu.co/">
                <img src="img/icono.jpeg" alt="Logo" width="20" height="20" class="me-2 rounded-circle">
                Progreuib
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link active text-white" href="index.php"><i class='bx bx-home'></i> Inicio</a></li>
                    <li class="nav-item"><a class="nav-link text-white" href="ofertas/ofertas.php"><i class='bx bx-briefcase'></i> Ofertas</a></li>
                    <li class="nav-item"><a class="nav-link text-white" href="register/register.php"><i class='bx bx-user-plus'></i> Registro</a></li>
                    <li class="nav-item"><a class="nav-link text-white" href="login/login.php"><i class='bx bx-log-in'></i> Iniciar Sesión</a></li>
                    <li class="nav-item"><a class="nav-link text-white" href="contact/contact.php"><i class='bx bx-envelope'></i> Contacto</a></li>
                </ul>
            </div>
        </div>
    </nav>
